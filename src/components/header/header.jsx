...
const Header = () => {
  return (
    <div className='whitebar'>
        ...
        <div className='divnav'> <Link to={"/"}>HOME</Link> <Link to={"/shopping"}>SHOP</Link> <Link to={"/About"}>ABOUT</Link> <Link to={"/colections"}>SALE</Link> <Link to={"/contact-us"}>CONTACT US</Link></div>
